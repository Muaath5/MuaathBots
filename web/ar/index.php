    ...
    <body>
        ...
        <main class="has-view">
            <section class="telegram-view">
                ...
                <h2>مرحبًا بك في موقع الآليين العرب</h2>
                <hr>
                <h1>آليون عصريون</h1>
                <h3>أسرع الآليين (البوتات) وأفضلها من ناحية الأداء والوظيفة!</h3>
            </section>
            <hr>
            <article>
                <h2>أين يمكنني أن أجد أشيائكم؟</h2>
                نحن نمتلك قناة ننشر فيها الآليين (البوتات) التي نصنعها.
                <br><br>
